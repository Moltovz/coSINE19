...
/obj/item/kirbyplants/dead
	name = "Research Director's potted plant"
	desc = "A gift from the botanical staff, presented after the Research Director's reassignment. There's a tag on it that says \"Y'all come back now, y'hear?\"\nIt doesn't look very healthy..."
	icon_state = "plant-25"
	trimmable = FALSE
