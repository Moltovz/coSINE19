...
/datum/controller/subsystem/id_access/proc/setup_access_descriptions()
	...
	desc_by_access["[ACCESS_RD]"] = "Research Director Office"
	...
	desc_by_access["[ACCESS_CMO]"] = "Chief Medical Officer Office"
	...
	desc_by_access["[ACCESS_SALVAGECREW]"] = "Shaft Miner"
	desc_by_access["[ACCESS_MAIL_SORTING]"] = "Cargo Office"
	desc_by_access["[ACCESS_VAULT]"] = "Main Vault"
	desc_by_access["[ACCESS_SALVAGECREW_STATION]"] = "Shaft Miner EVA"
	...
	desc_by_access["[ACCESS_CE]"] = "Chief Engineer Office"
