/datum/job/head_of_personnel
	...
	description = "The Head of Personnel is the Captain's second in command, who handles the day to day operations and bureaucracy of the Upper Decks. \
		Alter access on ID cards, manage civil and supply departments, \
		protect Ian, run the station when the Captain dies. See to the grievances of the crew. This is an extremely challenging position with high expectations, not recommended for new players."
