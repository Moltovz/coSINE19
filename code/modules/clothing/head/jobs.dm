...
/obj/item/clothing/head/warden/red
	...
	desc = "A head of security's hat. Looking at it gives you the feeling of wanting to keep people in cells for as long as possible."
...
/obj/item/clothing/head/surgerycap/cmo
	...
	desc = "The Chief Medical Officer's medical surgery cap to prevent their hair from entering the insides of the patient!"
