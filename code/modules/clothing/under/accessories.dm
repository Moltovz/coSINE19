...
/obj/item/clothing/accessory/medal/gold/captain
	name = "Captain's Right medal"
	desc = "A golden medal awarded exclusively to those promoted to the rank of Captain. It signifies the codified responsibilities of an Captain to the Unity, and their undisputable authority over their crew."
